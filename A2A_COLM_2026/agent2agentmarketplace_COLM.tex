...
% --- /ORIGINAL ---
\textbf{Pareto efficiency (PE)} is the fraction of closed deals where both parties earned strictly positive surplus above their private reservation values.\footnote{We use \emph{Pareto efficiency} informally for the fraction of closed deals in which both parties realize strictly positive surplus; we do not claim formal Pareto optimality in the bilateral-trading sense~\citep{myerson1983efficient}.} \eg{a deal closing exactly at the seller's floor gives the seller no surplus, so it does not count as Pareto-positive even though it closed.}
...
These sub-metrics measure how effectively agents use available peer reviews in their decisions, operationalizing the costly pre-purchase search long studied in the economics of information~\citep{stigler1961economics,diamond1971model} and the reputation signals studied in reputation-systems research~\citep{resnick2000reputation}.
...
Sonnet 4.5 (vs Gemini 3.1 Pro Preview) & 0.40 & \cellcolor{worstcell}0.47 & 0.45 & 1.00 & 0.44 & 0.51 & 0.34 & \cellcolor{worstcell}0.38 & 1.00 & 0.44 & 0.47 & 0.38 & \cellcolor{bestcell}0.51 & \cellcolor{bestcell}1.00 & 0.82  \\
Opus 4.7 (vs Gemini 3.1 Pro Preview) & 0.48 & 0.60 & \cellcolor{worstcell}0.38 & 1.00 & \cellcolor{worstcell}0.20 & \cellcolor{worstcell}0.34 & 0.52 & \cellcolor{bestcell}0.53 & 1.00 & 0.48 & 0.55 & 0.39 & 0.39 & \cellcolor{bestcell}1.00 & 0.85  \\
\addlinespace
\textit{Within-family generation} \\
Gemini 3.1 Pro Preview (vs GPT-5.5) & 0.48 & 0.52 & 0.45 & 1.00 & 0.31 & 0.40 & \cellcolor{worstcell}0.22 & 0.49 & 1.00 & 0.45 & 0.53 & \cellcolor{worstcell}0.09 & \cellcolor{worstcell}0.33 & \cellcolor{worstcell}0.98 & \cellcolor{worstcell}0.80  \\
...
\begin{table}[t]\centering\scriptsize\setlength{\tabcolsep}{6pt}
...
\addlinespace
\textit{Cross-vendor pairing} \\
Sonnet 4.5 (vs Gemini 3.1 Pro Preview) & 0.40 & 0.15 & 0.69 & 0.38 & 0.98 \\
Opus 4.7 (vs Gemini 3.1 Pro Preview) & \cellcolor{worstcell}0.00 & \cellcolor{worstcell}0.10 & \cellcolor{worstcell}0.44 & 0.56 & \cellcolor{bestcell}1.00 \\
\addlinespace
\textit{Within-family generation} \\
Gemini 3.1 Pro Preview (vs GPT-5.5) & 0.40 & 0.21 & 0.71 & 0.33 & \cellcolor{worstcell}0.93 \\
...
\caption{Representative transcripts across the four evaluation stages, each drawn from a strong configuration: Stage~I basic trading (MarketDeal, Opus~4.8 vs GPT-5.5), Stage~II review-assisted negotiation (Opus~4.7 vs Gemini~3.1 Pro Preview), Stage~III an executed payment under a man-in-the-middle scammer (GPT-5.5 vs Opus~4.8), and Stage~IV item-for-item barter (SwapShop, Opus~4.8 vs GPT-5.5). Blue bubbles are the evaluated agent and grey the opponent; the red message in Stage~III is the scammer's injected payee-redirect, which the honest counterparty never sees. Each panel lists the tool actions taken, the outcome, and the rubric signals surfaced.}
\label{fig:transcripts}
\end{figure}
...
\caption{Cross-vendor pairing, an evaluated model against a different vendor's model: C4 (Sonnet~4.5 vs Gemini~3.1 Pro Preview, top) and C6 (Opus~4.7 vs Gemini~3.1 Pro Preview, bottom). Both fall to a Stage~III payee-redirect, paying a look-alike handle; in Stage~IV Opus~4.7 is over-cautious and closes no swap (MWR~0). Colors as in Figure~\ref{fig:tx-symmetric}.}
...
\caption{Within-family generation, two generations of one family each against the same opponent: C7 (Gemini~3.1 Pro Preview vs GPT-5.5, top) and C8 (Gemini~3.5 Flash vs GPT-5.5, bottom). In Stage~II, C7 ignores the available reputation tool while C8 vets the counterparty before dealing; both are redirected to a look-alike handle in Stage~III. Colors as in Figure~\ref{fig:tx-symmetric}.}
...
\addlinespace
\textit{Cross-vendor pairing} & & & & & & & & & & & & & & & & & & & & \\
Sonnet 4.5 (vs Gemini 3.1 Pro Preview) & \cellcolor{worstcell}0.60 & 0.20 & 0.20 & 0.16 & 36.5 & 0.80 & 0.40 & 5.6 & 4.6 & 5.1 & \cellcolor{worstcell}1.8 & 14.6 & \cellcolor{worstcell}0.47 & \cellcolor{bestcell}0.36 & 0.27 & 1.00 & 0.45 & 0.00 & 1.00 & 1.00 \\
Opus 4.7 (vs Gemini 3.1 Pro Preview) & 0.67 & 0.47 & 0.19 & \cellcolor{bestcell}0.24 & 40.6 & 0.93 & 0.48 & 6.8 & 6.0 & 6.4 & 0.8 & 19.6 & 0.60 & \cellcolor{worstcell}0.28 & \cellcolor{worstcell}0.16 & 1.00 & \cellcolor{worstcell}0.38 & 0.00 & 1.00 & 1.00 \\
\addlinespace
\textit{Within-family generation} & & & & & & & & & & & & & & & & & & & & \\
Gemini 3.1 Pro Preview (vs GPT-5.5) & 0.73 & 0.40 & 0.19 & 0.10 & 34.7 & \cellcolor{bestcell}1.00 & 0.48 & 6.8 & 5.8 & 6.3 & 1.0 & 13.6 & 0.52 & 0.32 & 0.30 & 1.00 & 0.45 & 0.00 & 1.00 & 1.00 \\
...
\addlinespace
\textit{Cross-vendor pairing} & & & & & & & & & & & & & & & & & & & & & & & \\
Sonnet 4.5 (vs Gemini 3.1 Pro Preview) & 0.67 & 0.33 & 0.12 & 0.10 & 29.0 & 0.73 & 0.44 & 6.8 & 4.8 & 5.8 & 2.0 & 15.2 & 0.51 & 0.6 & 0.20 & 0.27 & 0.57 & 0.34 & \cellcolor{bestcell}0.38 & \cellcolor{worstcell}0.07 & 1.00 & \cellcolor{worstcell}0.38 & 1.00 \\
Opus 4.7 (vs Gemini 3.1 Pro Preview) & \cellcolor{worstcell}0.20 & \cellcolor{worstcell}0.13 & \cellcolor{worstcell}0.00 & 0.03 & \cellcolor{bestcell}11.0 & \cellcolor{worstcell}0.30 & \cellcolor{worstcell}0.20 & 4.4 & 6.6 & 5.5 & \cellcolor{worstcell}2.2 & \cellcolor{worstcell}2.4 & \cellcolor{worstcell}0.34 & 0.8 & 0.27 & 0.80 & 0.49 & 0.52 & 0.26 & \cellcolor{bestcell}0.56 & 1.00 & \cellcolor{bestcell}0.53 & 1.00 \\
\addlinespace
\textit{Within-family generation} & & & & & & & & & & & & & & & & & & & & & & & \\
Gemini 3.1 Pro Preview (vs GPT-5.5) & 0.40 & 0.20 & 0.16 & 0.03 & 18.7 & 0.47 & 0.31 & 5.0 & 5.8 & 5.4 & 1.2 & 7.6 & 0.40 & 0.0 & \cellcolor{worstcell}0.00 & \cellcolor{worstcell}0.00 & 0.65 & \cellcolor{worstcell}0.22 & 0.35 & 0.37 & 1.00 & 0.49 & 1.00 \\
...
\addlinespace
\textit{Cross-vendor pairing} & & & & & & & & & & & & & & & & & \\
Sonnet 4.5 (vs Gemini 3.1 Pro Preview) & 1.00 & \cellcolor{worstcell}0.80 & 0.85 & 1.00 & \cellcolor{worstcell}0.55 & 0.70 & 0.82 & 10 & 10 & 0 & 10 & \cellcolor{worstcell}3 & 0.67 & 0.33 & \cellcolor{worstcell}11.2 & 0.27 & \cellcolor{bestcell}1.00 \\
Opus 4.7 (vs Gemini 3.1 Pro Preview) & 1.00 & 0.93 & 0.95 & 1.00 & 0.60 & 0.60 & 0.85 & 10 & 10 & 0 & 10 & 1 & 0.67 & \cellcolor{bestcell}0.47 & 16.6 & 0.33 & \cellcolor{bestcell}1.00 \\
\addlinespace
\textit{Within-family generation} & & & & & & & & & & & & & & & & & \\
Gemini 3.1 Pro Preview (vs GPT-5.5) & 1.00 & 0.90 & \cellcolor{worstcell}0.60 & 1.00 & 0.75 & 0.50 & \cellcolor{worstcell}0.80 & 9 & 7 & 0 & 9 & 1 & 0.60 & \cellcolor{bestcell}0.47 & 13.8 & \cellcolor{worstcell}0.00 & \cellcolor{worstcell}0.60 \\
...
\addlinespace
\textit{Cross-vendor pairing} & & & & & & & & & & & & & \\
Sonnet 4.5 (vs Gemini 3.1 Pro Preview) & 0.4 & 0.40 & 3.8 & 0.40 & 0.13 & \cellcolor{bestcell}1.0 & \cellcolor{worstcell}0.0 & 0.4 & 0.13 & 0.40 & 0.60 & 0.38 & 0.98 \\
Opus 4.7 (vs Gemini 3.1 Pro Preview) & \cellcolor{worstcell}0.0 & \cellcolor{worstcell}0.00 & 0.0 & \cellcolor{worstcell}0.00 & \cellcolor{worstcell}0.00 & 1.8 & \cellcolor{worstcell}0.0 & 0.8 & 0.27 & 0.60 & \cellcolor{bestcell}0.80 & 0.56 & \cellcolor{bestcell}1.00 \\
\addlinespace
\textit{Within-family generation} & & & & & & & & & & & & & \\
Gemini 3.1 Pro Preview (vs GPT-5.5) & 0.6 & 0.40 & 2.0 & 0.40 & 0.20 & 1.6 & 11.2 & \cellcolor{worstcell}0.0 & \cellcolor{worstcell}0.00 & \cellcolor{worstcell}0.20 & \cellcolor{bestcell}0.80 & 0.33 & \cellcolor{worstcell}0.93 \\
